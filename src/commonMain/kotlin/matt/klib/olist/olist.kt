...
class AddAtEnd<E>(collection: Collection<E>, added: E):
  Addition<E>(collection, added)

class AddAt<E>(collection: Collection<E>, added: E, val index: Int):
  Addition<E>(collection, added)

sealed class MultiAddition<E>(override val collection: Collection<E>, val added: Collection<E>): CollectionChange<E>
class MultiAddAtEnd<E>(collection: Collection<E>, added: Collection<E>):
...
class RemoveElements<E>(collection: Collection<E>, removed: Collection<E>):
...
class ReplaceElement<E>(collection: Collection<E>, removed: E, added: E):
